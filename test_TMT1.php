...
<body>
    <center>
        <h2>Test TMT "grefex" - Partie A</h2>
        <br>
    ...
    ?>
        ...
        <form method="post" name="insertion" action="test_TMT2.php">
            ...
            <label for="errors1">Nombre d'erreur du patient (entre 0 et 25):</label>
            <input type="number" id="errors1" name="errors1" min="0" max="25" placeholder="0">
            <br><br> <!--- Espace pour enregistrer un scan du document -->
            <input type="hidden" name="MAX_FILE_SIZE" value="250000" />
            <input type="file" name="photo_TMT1" size=50 />
            <br><br>
